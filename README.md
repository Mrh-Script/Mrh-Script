...
I am **Md Riad Hasan**, a **Computer Science and Engineering** student at Uttara University, Bangladesh. My current focus is on **Machine Learning and Artificial Intelligence**, alongside a continuous exploration of complex algorithms. I have built a strong foundation in **Data Structures and Algorithms** using C++ and Python, and I actively develop **web-based solutions**. 

Beyond my focus on AI, I have hands-on experience building robust software applications using **Java and C#**. I thrive on collaborating on innovative tech projects, engaging in analytical research, and actively contributing to open-source software.
...
👉 [Web Technologies](https://mrh.page.gd)
👉 [Google Site](https://www.sites.google.com/uttarauniversity.edu.bd/mrh-portfolio/)
